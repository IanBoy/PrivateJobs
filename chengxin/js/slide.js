...
function WSCMobileSlide(arg_obj) {
    ...
    */
    ...
    function tongbu(ini){
            var tt = $("#WSCSlideStatus li");
            tt.removeClass("sel");
            $(tt.get(ini)).addClass("sel");
        }
    ...
    function getSlideTimer(timeNum) {
        ...
        var slideTimer = setInterval(function() {
            var x = getTransform(".WSCSlide").m41,y,z;
            y = x - ImgWidth;
            z = Math.abs(y / ImgWidth);
            if(z > 4){
                z = 0;
            }
            tongbu(z);
            slideAnimate(y, endPosition);
